        ...
        return (
            <div className="page-container flex flex-col items-center justify-center min-h-[70vh] text-center">
                <div className="clean-card p-12 max-w-md w-full">
                    ...
                    <p className="text-gray-600 text-sm mb-6">You haven't added any gear to your cart yet.</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    {cart.map((item) => (
                        <div key={item.id} className="clean-card p-4 flex flex-col sm:flex-row items-center gap-4">
                            ...
                            <div className="flex-grow w-full text-center sm:text-left">
                                ...
                                <h3 className="text-gray-900 font-medium text-sm mb-1">{item.name}</h3>
                ...
                <div className="lg:col-span-4">
                    <div className="clean-card p-6 sticky top-24">
                        <h3 className="text-base font-semibold text-gray-900 mb-4 border-b border-gray-100 pb-4">Order Summary</h3>
                        ...
                        <button
                            onClick={clearCart}
                            className="w-full text-gray-500 text-xs hover:text-gray-900 transition-colors"
                        >
                            Clear Cart
                        </button>
                    </div>
