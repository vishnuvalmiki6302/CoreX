    ...
    return (
        <div className="relative overflow-hidden min-h-screen flex items-center">
            ...
            <motion.div
                ...
                className="absolute top-0 right-0 w-[800px] h-[800px] bg-gym-accent/10 rounded-full blur-[120px] z-0"
            />

            <motion.div
                animate={{ scale: [1, 1.3, 1], x: [0, 100, 0] }}
                transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
                className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gym-gold/5 rounded-full blur-[100px] z-0"
            />
